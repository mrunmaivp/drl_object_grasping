...
class PandaGraspingEnv(gym.Env):
    ...
    def _set_obj_initial_pose(self):
        obj_initial_position = [0.5, 0, 0.02]
        obj_initial_orientation = [0,0,0,1]
        return obj_initial_position, obj_initial_orientation
    ...
    def _get_new_observation(self):
        ...
        current_obj_position, current_obj_orientation = self._set_obj_initial_pose()
    ...
    def step(self, action):
        ...
        reward = self.calculate_reward(done, is_optimal_grasp, next_observation, execution_status, out_of_workspace_flag, [next_observation[-1], next_observation[-2]], next_observation[-4], orientation_difference_value, gripper_force)
        # print("REWARD", reward)
    ...
    def check_angle_difference(self, orientation_difference):
        ...
        if np.isclose(orientation_difference, closest_desired_difference, atol=0.05):
    ...
    def grasp_object(self, next_state, action):
        ...
        object_position = self._set_obj_initial_pose()
