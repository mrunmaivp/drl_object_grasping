...
def train():
    ...
    agent.load_checkpoint(ckpt_path="/home/ros2/mt_panda_grasping_ws/src/panda_grasping/panda_gym/panda_gym/rl/checkpoints/sac_checkpoint_PandaEnv_2023-12-17_11-40-23", evaluate=False)
    ...
    for i_episode in itertools.count(1):
        ...
        while not done and max_timesteps_per_episode < 100:
    ...
    agent.save_checkpoint("PandaEnv", suffix=datetime.datetime.now().strftime("%Y-%m-%d_%H-%M-%S"))
    env.close()
