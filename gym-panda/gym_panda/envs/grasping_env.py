...
class Grasping(gym.Env):
    ...
    def _get_observation_space(self):
        ...
        lower_limits = np.concatenate((lower_relative_position, lower_relative_orientation, lower_obj_distance , lower_gripper_force, lower_tcp_ft ))
        upper_limits = np.concatenate((upper_relative_position, upper_relative_orientaiton, upper_obj_distance, upper_gripper_force, upper_tcp_ft))
    ...
    def step(self, action):
        ...
        reward = self.calculate_reward(done, is_optimal_grasp, is_object_lifted, next_observation, check_obj_position, execution_status, out_of_workspace_flag, next_observation[6], orientation_difference_value, gripper_force)
